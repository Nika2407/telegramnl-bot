...
FAQ_QUESTIONS_TO_FILE = {  # Соответствие вопросов файлам
...
# Картинки для некоторых FAQ (ключ — вопрос, значение — список картинок)
...
# Сертификаты — отправим сообщение, но можно добавить фото отдельно
CERTIFICATES_TEXT = (
...
def faq_menu_keyboard():
    # Добавим кнопки вопросов + кнопки "Назад" и "Меню"
...
async def reply_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == '📚 1️⃣ Часто задаваемые вопросы':
        ...
        # Здесь можно отправлять фото сертификатов, пока просто сообщение
...
if __name__ == '__main__':
    # Запуск бота
    TOKEN = '8078249773:AAEtvm-luYpFNZFSZP8Nw6jkOwpZon84jSE'  # <-- замени на свой токен
